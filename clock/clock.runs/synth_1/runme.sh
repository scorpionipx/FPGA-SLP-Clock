...
HD_PWD='C:/Users/uidq6025/clock_slp/clock_slp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_slp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_slp.tcl
