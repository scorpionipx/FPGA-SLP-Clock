...
HD_PWD='C:/Users/uidq6025/clock_slp/clock_slp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_slp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_slp.tcl -notrace
